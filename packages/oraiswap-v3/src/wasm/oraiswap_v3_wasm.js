 ...
 * @returns {SwapResult}
 */
function computeSwapStep(current_sqrt_price, target_sqrt_price, liquidity, amount, by_amount_in, fee) {
  try {
 ...
 * @returns {SqrtPrice}
 */
function getNextSqrtPriceFromInput(starting_sqrt_price, liquidity, amount, x_to_y) {
  try {
    const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
 ...
 * @returns {SqrtPrice}
 */
function getNextSqrtPriceFromOutput(starting_sqrt_price, liquidity, amount, x_to_y) {
  try {
    const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
 ...
 * @returns {SqrtPrice}
 */
function getNextSqrtPriceYDown(starting_sqrt_price, liquidity, y, add_y) {
  try {
    const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
 ...
 * @returns {boolean}
 */
function isEnoughAmountToChangePrice(amount, starting_sqrt_price, liquidity, fee, by_amount_in, x_to_y) {
  try {
    const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
 ...
 * @returns {boolean}
 */
function checkTickToSqrtPriceRelationship(tick_index, tick_spacing, sqrt_price) {
  try {
    const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
 ...
 */
function getLiquidityByX(x, lower_tick, upper_tick, current_sqrt_price, rounding_up) {
  try {
    const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
 ...
 * @returns {SingleTokenLiquidity}
 */
function getLiquidityByY(y, lower_tick, upper_tick, current_sqrt_price, rounding_up) {
  try {
    const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
 ...
 */
function simulateSwap(tickmap, fee_tier, pool, ticks, x_to_y, amount, by_amount_in, sqrt_price_limit) {
  try {
    const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
    wasm.simulateSwap(
      retptr,
