...
describe("test-integration", () => {
  ...
  it("[EVM->Oraichain] full-flow happy test", async () => {
    ...
    // TEST DATA
    expect(
      await duckDb.queryInitialEvmStateByHash("0xf55ed0825f55f18bd6ae618127e8cc0d889cc3253442ebe88c9280d669ebafb4")
    ).toEqual({
    ...
    expect(await duckDb.queryOraiBridgeStateBySequence(18337)).toEqual({
    ...
    expect(await duckDb.queryOraichainStateBySequence(18337)).toEqual({
  ...
  it("[EVM->Cosmos] full-flow happy test", async () => {
    ...
    // Test Data
    expect(
      await duckDb.queryInitialEvmStateByHash("0xe551efd736461673ee952881c49923d2bb4fba538aa1771775d4d5bc02f97c8f")
    ).toEqual({
    ...
    expect(await duckDb.queryOraiBridgeStateBySequence(18434)).toEqual({
    ...
    expect(await duckDb.queryOraichainStateBySequence(18434)).toEqual({
  ...
  it("[EVM->EVM] full-flow happy test", async () => {
    ...
    // TEST DATA
    expect(
      await duckDb.queryInitialEvmStateByHash("0xdb03f0cb45506b7725cf04c62035b38a8362a51bc15e24b3706cbc45a17ef27d")
    ).toEqual({
    ...
    expect(await duckDb.queryOraiBridgeStateByEventNonceAndEvmChainPrefix(63870, "oraib")).toEqual({
    ...
    expect(await duckDb.queryOraichainStateBySequence(18501)).toEqual({
    ...
    expect(await duckDb.queryOraiBridgeStateBySequence(21456)).toEqual({
    ...
    expect(await duckDb.queryInitialEvmStateByEventNonceAndEvmChainPrefix(6501, "eth-mainnet")).toEqual({
      txHash: "",
      height: 0,
      prevState: "OraiBridgeState",
  ...
  it("[Cosmos->EVM] full-flow happy test", async () => {
    ...
    // Test data test
    expect(await duckDb.queryOraichainStateBySequence(21698)).toEqual({
    ...
    expect(await duckDb.queryOraiBridgeStateBySequence(21698)).toEqual({
    ...
    expect(await duckDb.queryInitialEvmStateByEventNonceAndEvmChainPrefix(64152, "oraib")).toEqual({
      txHash: "",
      height: 0,
      prevState: "OraiBridgeState",
  ...
  it("[Oraichain->EVM] full-flow happy test", async () => {
    ...
    // Test Data
    expect(await duckDb.queryOraichainStateBySequence(21688)).toEqual({
    ...
    expect(await duckDb.queryOraiBridgeStateBySequence(21688)).toEqual({
    ...
    expect(await duckDb.queryInitialEvmStateByEventNonceAndEvmChainPrefix(64140, "oraib")).toEqual({
      txHash: "",
      height: 0,
      prevState: "OraiBridgeState",
  ...
  xit("[EVM->EVM] testing timeout on oraiBridge missing event", async () => {
    const ethEvent = new EthEvent(evmHandler);
    const gravity = ethEvent.listenToEthEvent(
      owner.provider,
      "0xb40C364e70bbD98E8aaab707A41a52A2eAF5733f",
