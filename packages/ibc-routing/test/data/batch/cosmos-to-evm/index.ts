...
export const IbcTransferTxData1 = JSON.parse(
  fs.readFileSync(path.join(__dirname, "./ibc_transfer1.json")).toString("utf-8")
);

export const IbcTransferTxData2 = JSON.parse(
  fs.readFileSync(path.join(__dirname, "./ibc_transfer2.json")).toString("utf-8")
);
