...
import { WETH_CONTRACT, NTMPI_CONTRACT } from "@oraichain/oraidex-common/build/constant";
...
export const pairs: PairMapping[] = [
  ...
  {
    asset_infos: [{ token: { contract_addr: NTMPI_CONTRACT } }, { token: { contract_addr: usdcCw20Address } }],
