...
export const pairs: PairMapping[] = [
  {
    asset_infos: [
      ...
      { token: { contract_addr: airiCw20Adress } },
    ],
  },
  {
    asset_infos: [
      { native_token: { denom: ORAI } },
      { token: { contract_addr: oraixCw20Address } },
    ],
  },
  {
    asset_infos: [
      { native_token: { denom: ORAI } },
      { token: { contract_addr: scOraiCw20Address } },
    ],
  },
  {
    asset_infos: [
  ...
  },
  {
    asset_infos: [
      { native_token: { denom: ORAI } },
      { token: { contract_addr: usdtCw20Address } },
    ],
  },
  {
    asset_infos: [
      { native_token: { denom: ORAI } },
      { token: { contract_addr: kwtCw20Address } },
    ],
  },
  {
    asset_infos: [
  ...
  {
    asset_infos: [
      { token: { contract_addr: milkyCw20Address } },
      { token: { contract_addr: usdtCw20Address } },
    ],
  },
  {
