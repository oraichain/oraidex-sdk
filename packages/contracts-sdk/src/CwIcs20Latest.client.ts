...
export interface CwIcs20LatestInterface extends CwIcs20LatestReadOnlyInterface {
  ...
  transferFee: ($fee?: number | StdFee | "auto", $memo?: string, $funds?: Coin[]) => Promise<ExecuteResult>;
}
export class CwIcs20LatestClient extends CwIcs20LatestQueryClient implements CwIcs20LatestInterface {
  ...
  transferFee = async ($fee: number | StdFee | "auto" = "auto", $memo?: string, $funds?: Coin[]): Promise<ExecuteResult> => {
    return await this.client.execute(this.sender, this.contractAddress, {
      transfer_fee: {}
    }, $fee, $memo, $funds);
  };
