...
const router = {
  ...
  returnAmount: "471547839267",
  routes: [
    {
      swapAmount: "40000000000",
      returnAmount: "161695149583",
      paths: [
        {
          chainId: "Oraichain",
          tokenIn: "orai",
          tokenInAmount: "40000000000",
          tokenOut: "orai15un8msx3n5zf9ahlxmfeqd2kwa5wm0nrpxer304m9nd5q6qq0g6sku5pdd",
          tokenOutAmount: "161695149583",
          tokenOutChainId: "Oraichain",
          actions: [
            {
              type: "Swap",
    ...
    {
      swapAmount: "20000000000",
      returnAmount: "142999518000",
      paths: [
        {
          chainId: "Oraichain",
          tokenIn: "orai",
          tokenInAmount: "20000000000",
          tokenOut: "uatom",
          tokenOutAmount: "22344219440",
          tokenOutChainId: "cosmoshub-4",
          actions: [
            {
              type: "Swap",
        ...
        },
        {
          chainId: "noble-1",
          tokenIn: "uusdc",
          tokenInAmount: "143145256448",
          tokenOut: "orai15un8msx3n5zf9ahlxmfeqd2kwa5wm0nrpxer304m9nd5q6qq0g6sku5pdd",
          tokenOutAmount: "142999518000",
          tokenOutChainId: "Oraichain",
          actions: [
            {
              type: "Bridge",
    ...
    },
    {
      ...
      paths: [
        ...
        },
        {
          chainId: "noble-1",
          tokenIn: "uusdc",
          tokenInAmount: "42504947241",
          tokenOut: "orai15un8msx3n5zf9ahlxmfeqd2kwa5wm0nrpxer304m9nd5q6qq0g6sku5pdd",
          tokenOutAmount: "42459849102",
          tokenOutChainId: "Oraichain",
          actions: [
            {
              type: "Bridge",
    ...
    },
    {
      ...
      paths: [
        ...
        },
        {
          chainId: "noble-1",
          tokenIn: "uusdc",
          tokenInAmount: "36677637125",
          tokenOut: "orai15un8msx3n5zf9ahlxmfeqd2kwa5wm0nrpxer304m9nd5q6qq0g6sku5pdd",
          tokenOutAmount: "36638366296",
          tokenOutChainId: "Oraichain",
          actions: [
            {
              type: "Bridge",
...
const alphaSwapToOraichain = async () => {
  ...
  const originalToToken = cosmosTokens.find((t) => t.coinGeckoId === "usd-coin" && t.chainId === "Oraichain");
